...
$(document).ready(function () {
  $(".gallery div a").attr("data-fancybox", "mygallery");
...
$(document).ready(function () {
  $(".master div a").fancybox();
});

$(document).ready(function () {
  $(".master div a").attr("data-fancybox", "mygallery");
  $(".master div a ").each(function () {
    $(this).attr("data-caption", $(this).find("img").attr("alt"));
    $(this).attr("title", $(this).find("img").attr("alt"));
  });
  $(".master div a ").fancybox();
...
$(document).ready(function () {
  $(".floor-plans div a").fancybox();
});

$(document).ready(function () {
  $(".floor-plans div a").attr("data-fancybox", "mygallery");
  $(".floor-plans div a ").each(function () {
    $(this).attr("data-caption", $(this).find("img").attr("alt"));
    $(this).attr("title", $(this).find("img").attr("alt"));
  });
  $(".floor-plans div a ").fancybox();
